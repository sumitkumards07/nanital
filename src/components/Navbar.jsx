...
const navLinks = [
  ...
  { label: 'About', to: '/about' },
  {
    ...
    children: [
      ...
      { label: '2 Bed Deluxe', to: '/rooms/2-bed-deluxe-room' },
      { label: '2 Bed Super Deluxe', to: '/rooms/2-bed-super-deluxe-room' },
      { label: '4 Bed Deluxe', to: '/rooms/4-bed-deluxe-room' },
      { label: '4 Bed Super Deluxe', to: '/rooms/4-bed-super-deluxe-room' },
      { label: 'Luxury Room', to: '/rooms/luxury-room' },
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="hidden lg:block">+91 7206073010</span>
          </a>
