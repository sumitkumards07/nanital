    ...
    <div className="pt-20">
      <div className="page-hero">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <motion.p initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.3}} className="font-sans text-slate-400 mt-3 text-sm">A visual journey through Alka The Lake View Hotel</motion.p>
        </div>
      </div>
