...
export default function Booking() {
  ...
  return (
    <div className="pt-20">
    <Helmet>
      <title>Book Alka The Lake View Hotel | Nainital Accommodation</title>
      <meta name="description" content="Securely book your stay at Alka The Lake View Hotel. We offer assisted concierge booking for rooms on Mall Road, Nainital." />
    </Helmet>
      <div className="page-hero">
        <div className="absolute inset-0 opacity-20"><img src="/images/hotel_exterior_terrace.webp" alt="bg" className="w-full h-full object-cover" fetchpriority="high" /></div>
          ...
          <motion.div initial={{opacity:0,x:40}} animate={{opacity:1,x:0}} transition={{duration:0.6,delay:0.1}} className="space-y-6">
            ...
            <div className="bg-dark border border-primary/20 rounded-xl p-6">
              ...
              <div className="space-y-3">
                {[{icon:'call',label:'Call Us',val:'+91 9625081694',href:'tel:+919625081694'},{icon:'mail',label:'Email Us',val:'support@alkahotel-partner.online',href:'mailto:support@alkahotel-partner.online'}].map(c => (
              ...
              <a href="https://wa.me/919625081694" target="_blank" rel="noopener noreferrer"
