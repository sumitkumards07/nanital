...
const policies = [
  ...
  { icon:'smoke_free',    title:'Smoking Policy',       items:['Alka The Lake View Hotel is a 100% smoke-free property','Smoking prohibited in all rooms and indoor areas','Designated outdoor smoking areas are available','Violation incurs a ₹1,500 deep-cleaning fee','Policy applies to cigarettes, e-cigarettes, cigars, and hookahs'] },
...
export default function Policies() {
  ...
  return (
    <div className="pt-20">
    <Helmet>
      <title>Hotel Policies | Alka The Lake View Hotel</title>
      <meta name="description" content="Read the check-in, check-out, and general hotel policies for Alka The Lake View Hotel before you book your stay." />
    </Helmet>
      <div className="page-hero">
        <div className="absolute inset-0 opacity-20"><img src="/images/hotel_lobby_staircase.webp" alt="bg" className="w-full h-full object-cover" fetchpriority="high" /></div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}}
            ...
            <div>
              ...
              <p className="font-sans text-slate-400 text-sm mt-1 leading-relaxed">By making a reservation at Alka The Lake View Hotel, you agree to abide by all hotel policies listed below. For clarifications, contact us before arrival.</p>
            </div>
          </motion.div>
