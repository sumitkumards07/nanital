...
export default function ThingsToDo() {
  useEffect(() => { document.title = 'Things To Do in Nainital – Nainital Lake View Hotel'; window.scrollTo(0,0) }, [])
  return (
    <div className="pt-20">
      <div className="page-hero">
        <div className="absolute inset-0 opacity-30"><img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1920&q=60" alt="bg" className="w-full h-full object-cover" /></div>
