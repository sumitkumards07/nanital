        ...
        <div className="max-w-3xl mx-auto">
          ...
          <motion.div initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} viewport={{once:true}}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:+917351042519" className="inline-flex items-center gap-2 bg-dark text-primary px-6 py-3 rounded-lg font-sans font-bold text-sm uppercase hover:bg-dark/80 transition-all">
                <span className="material-symbols-outlined text-sm">call</span> Call: +91 7351042519
              </a>
