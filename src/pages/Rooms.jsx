...
export default function Rooms() {
  ...
  return (
    <div className="pt-20">
    <Helmet>
      <title>Rooms & Suites | Alka Hotel Nainital Booking</title>
      <meta name="description" content="Explore premium rooms with lake views at Alka Hotel Nainital. View tariffs, amenities, and book your stay securely through our agency." />
    </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-3">
              <a href="tel:+919625081694" className="flex items-center gap-2 bg-primary text-dark px-5 py-2.5 rounded-lg font-sans font-bold text-sm uppercase">
