  ...
  return (
    <div className="pt-20">
      <div className="page-hero">
        <div className="absolute inset-0 opacity-25"><img src="https://images.unsplash.com/photo-1578683010236-d716f9a3f461?w=1920&q=60" alt="bg" className="w-full h-full object-cover" /></div>
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <motion.p initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.3}} className="font-sans text-slate-400 mt-3 text-sm">48 carefully curated rooms — from cozy retreats to lavish suites</motion.p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-3">
              <a href="tel:8252561063" className="flex items-center gap-2 bg-primary text-dark px-5 py-2.5 rounded-lg font-sans font-bold text-sm uppercase">
