...
export default function Testimonials() {
  useEffect(() => { document.title = 'Guest Reviews – Alka The Lake Side Hotel'; window.scrollTo(0,0) }, [])
  return (
    <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} viewport={{once:true}}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://wa.me/917496036859?text=I%20would%20like%20to%20share%20my%20feedback%20about%20Nainital%20Lake%20View%20Hotel."
