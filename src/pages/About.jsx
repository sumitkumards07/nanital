    ...
    <div className="pt-20">
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <a href="https://wa.me/917351042519?text=Hello%2C%20I%20would%20like%20to%20enquire%20about%20booking%20a%20room." target="_blank" rel="noopener noreferrer" className="inline-block bg-dark text-primary px-8 py-4 rounded-lg font-sans font-bold uppercase tracking-wide hover:bg-dark/80 transition-all text-sm">
            Book Your Stay
          </a>
        </div>
      </section>
